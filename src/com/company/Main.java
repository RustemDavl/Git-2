    ...
    public static void main(String[] args) {Scanner scanner = new Scanner(System.in);
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                //        moneyBeforeSalary = saveExpense(moneyBeforeSalary, expense, day);

            } else if (command == 4) {
                expensesManager.printAllExpenses();
            } else if (command == 5) {
                System.out.println("Самая большая сумма расходов на этой неделе составила " + expensesManager.findMaxExpense(/*expenses*/) + " руб.");
            } else if (command == 0) {
